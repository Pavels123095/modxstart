...
<link rel="stylesheet" href="[[++base_url]]assets/templates/warped/css/1.css" type="text/css" media="screen,projection" />
<script src="[[++base_url]]assets/templates/warped/main.js"></script>
</head>
...
<body>
	...
	<div id="content">
			...
			<h2><a href="#" id="intro">Introduction</a></h2>
							...
							<h2>Here is your Revolution content</h2>
							[[*content]]
